...
function gerarNumeroAleatorio() {
    ...
    let quantidadeDeElementosNaLista =  listasDeNumeroSorteados.length;

    if(quantidadeDeElementosNaLista == numeroLimite) {
        listasDeNumeroSorteados = [];
    }
    if (listasDeNumeroSorteados.includes(numeroEscolhido)) {
        return gerarNumeroAleatorio();
    } else {
        listasDeNumeroSorteados.push(numeroEscolhido);
